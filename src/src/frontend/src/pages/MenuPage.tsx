...
import { ArrowRight, ChefHat, Minus, Plus } from "lucide-react";
...
export default function MenuPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Menu Items */}
      <main
        className={`flex-1 px-4 py-4 ${cartItemCount > 0 ? "pb-28" : "pb-6"}`}
        data-ocid="menu.list"
      >
        {isLoading ? (
      ...
      <AnimatePresence>
        {cartItemCount > 0 && (
          ...
          >
            ...
            >
              View Order & Pay <ArrowRight className="w-4 h-4 ml-1" />
            </Button>
          </motion.div>
        )}
      </AnimatePresence>
